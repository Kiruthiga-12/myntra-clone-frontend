...
const Women_Category = (props) => {
    const women_msg = 'Displays Women Category data';
    const [subcat, setSubCat] = useState();
    const [prodcat, setProdCat] = useState();
    useEffect(() => {
        toast.info('Displays Women category data', { toastId: 'women_msg' })
    }, [])
    useEffect(() => {
    ...
    return (
        <>
            ...
            <SelectCat cat='Women' />
            <DataHeader />
            <DataRow cat='Women' subcat={props.subcategory} prodcat={props.productcategory} adminid={props.adminid}/>
        </>
    )
}
...
export default connect(mapStateToProps, null)(Women_Category);
