...
const DataEdit = (props) => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/branddetails_email?email=${props.email}`)
            .then(async (data) => {
                (data.data.length > 0) ? setBrandName(data.data.slice()) : setBrandName([])
            })
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/vendor_details?email=${props.email}`)
            .then((data) => {
        ...
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/get_product_product_id?product_id=${props.pid}`)
            .then((data) => {
                if (data.data.length > 0)
                    if (data.data[0].product_id != undefined) {
                        ...
                        setStrikePrice(Number(data.data[0].strike_price));
                        setDiscount(Number(data.data[0].discount));
                        setPrice(Number(data.data[0].price));
    ...
    return (<>
        {loader == true ? <Loader /> : <>
            ...
            <Box sx={{ paddingTop: '20px', paddingLeft: '20px', marginLeft: '20px', marginTop: '100px', backgroundColor: 'white', width: '90%', marginRight: '40px' }}>
                ...
                <br></br>
                <img src={`data:image/png;base64,${image1}`} alt='loading' width='120px' height='100px' id='pimage1' />
                ...
                <br></br>
                <img src={`data:image/png;base64,${image2}`} alt='loading' width='120px' height='100px' id='pimage2' />
                <TextField variant='standard' type='file' sx={{ marginLeft: '30px', fontFamily: "cursive", fontWeight: "bold", fontSize: '18px' }}
                    onChange={async (e) => {
                        document.getElementById('pimage2').style.display = 'none';
                ...
                <br></br>
                <img src={`data:image/png;base64,${image3}`} alt='loading' width='120px' height='100px' id='pimage3' />
                <TextField variant='standard' type='file' sx={{ marginLeft: '30px', fontFamily: "cursive", fontWeight: "bold", fontSize: '18px' }}
                    onChange={async (e) => {
                        document.getElementById('pimage3').style.display = 'none';
                ...
                <br></br>
                <img src={`data:image/png;base64,${image4}`} alt='loading' width='120px' height='100px' id='pimage4' />
                <TextField variant='standard' type='file' sx={{ marginLeft: '30px', fontFamily: "cursive", fontWeight: "bold", fontSize: '18px' }}
                    onChange={async (e) => {
                        document.getElementById('pimage4').style.display = 'none';
                ...
                <br></br>
                <img src={`data:image/png;base64,${image5}`} alt='loading' width='120px' height='100px' id='pimage5' />
                <TextField variant='standard' type='file' sx={{ marginLeft: '30px', fontFamily: "cursive", fontWeight: "bold", fontSize: '18px' }}
                    onChange={async (e) => {
                        document.getElementById('pimage5').style.display = 'none';
                ...
                <br></br>
                <img src={`data:image/png;base64,${image6}`} alt='loading' width='120px' height='100px' id='pimage6' />
                <TextField variant='standard' type='file' sx={{ marginLeft: '30px', fontFamily: "cursive", fontWeight: "bold", fontSize: '18px' }}
                    onChange={async (e) => {
                        document.getElementById('pimage6').style.display = 'none';
                        ...
                        async () => {
                            async function fun1() {
                                if (image1flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image1}`, 'edit_product.png');
                                    if (file != undefined) {
                                        setImg1(file);
                                    }
                                }
                            ...
                            async function fun2() {
                                if (image2flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image2}`, 'edit_product2.png');
                                    if (file != undefined) {
                                        setImg2(file);
                                    }
                                }
                            ...
                            async function fun3() {
                                if (image3flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image3}`, 'edit_product3.png');
                                    if (file != undefined) {
                                        setImg3(file);
                                    }
                                }
                            ...
                            async function fun4() {
                                if (image4flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image4}`, 'edit_product4.png');
                                    if (file != undefined) {
                                        setImg4(file);
                                    }
                                }
                            ...
                            async function fun5() {
                                if (image5flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image5}`, 'edit_product5.png');
                                    if (file != undefined) {
                                        setImg5(file);
                                    }
                                }
                            ...
                            async function fun6() {
                                if (image6flag == false) {
                                    ...
                                    const file = dataURLtoFile(`data:image/png;base64,${image6}`, 'edit_product6.png');
                                    if (file != undefined) {
                                        setImg6(file);
                                    }
                                }
